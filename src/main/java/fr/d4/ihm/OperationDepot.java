package fr.d4.ihm;
	...
	public class OperationDepot extends javax.swing.JFrame {
	    ...
	    private void initComponents() {
	        ...
	        jLabel2.setText("Operation Depôt");
	        ...
	        jLabel7.setText("Compte à créditer :");
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(OperationDepot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        ...
	        java.awt.EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                new OperationDepot().setVisible(true);
	            }
	        });
	    }
